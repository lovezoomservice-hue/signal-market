...
function buildWSO(signal, graphEdges=[]) {
  ...
  return {
    ...
    causal_explanation: {
      ...
      monitoring_points:      CAUSAL_KB[signal.topic]?.monitoring_points || [
        `Weekly arXiv paper volume in ${signal.topic} categories`,
        'GitHub repository growth in related tools',
        'Conference acceptance rates at NeurIPS/ICML/ICLR',
      ],
